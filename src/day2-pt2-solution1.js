 ...
 * // => 9
 */
function checkSumDivisible(digitString) {
	return digitString.split('\n').reduce((result, row) => result += getDiffDivisible(row.split('\t')), 0);
}
...
results.checkSumDivisible = checkSumDivisible(digitString);
